...
const moduleColors = {
  ...
  'image_generation': { bg: '#fff1f0', color: '#ff4d4f', icon: '#ff4d4f' },
  'html_editor': { bg: '#e6fffb', color: '#13c2c2', icon: '#13c2c2' },
  'storage': { bg: '#fff7e6', color: '#fa8c16', icon: '#fa8c16' },
  'video_generation': { bg: '#f0f5ff', color: '#2f54eb', icon: '#2f54eb' },
  'mindmap': { bg: '#f6ffed', color: '#52c41a', icon: '#52c41a' },
  'ocr': { bg: '#fff0f6', color: '#eb2f96', icon: '#eb2f96' },
