 ...
 *   art        封面背景图案（slideArt.js 程序生成）none | blobs 光斑 | rings 圆环 | diagonal 斜色带 |
 *              dots 点阵 | waves 波浪 | mesh 低多边形 | grid 蓝图网格 | glow 极光光带 | chalk 粉笔 | frame 描边框
 *   contentArt 内容页背景装饰（很淡）none | corner 角落光斑 | grid 网格 | frame 细框 | chalk 粉笔框 | waves 角落波浪
 ...
 * 字体：titleFont / bodyFont 是 pptx 的 fontFace；titleStack 是预览用 CSS 字体栈（缺省无衬线）。
 */

export const SLIDE_FONT_FACE = 'Microsoft YaHei'
export const SLIDE_SERIF_FONT_FACE = 'SimSun'
export const SLIDE_KAI_FONT_FACE = 'KaiTi'
...
export const SLIDE_KAI_FONT_STACK = 'KaiTi, STKaiti, "Kaiti SC", "楷体", "Noto Serif CJK SC", cursive'

const sans = { titleFont: SLIDE_FONT_FACE, bodyFont: SLIDE_FONT_FACE, titleStack: SLIDE_FONT_STACK, serif: false }
const serif = { titleFont: SLIDE_SERIF_FONT_FACE, bodyFont: SLIDE_FONT_FACE, titleStack: SLIDE_SERIF_FONT_STACK, serif: true }
const kai = { titleFont: SLIDE_KAI_FONT_FACE, bodyFont: SLIDE_KAI_FONT_FACE, titleStack: SLIDE_KAI_FONT_STACK, serif: true }

/** 主题顺序即选择器里的顺序 */
export const SLIDE_THEMES = Object.freeze({
  classic: {
    key: 'classic', ...sans,
    cover: 'solid', decor: 'none', content: 'accent-bar', art: 'diagonal', contentArt: 'none',
  ...
  business: {
    key: 'business', ...sans,
    cover: 'gradient', decor: 'lines', content: 'title-band', art: 'rings', contentArt: 'corner',
  ...
  tech: {
    key: 'tech', ...sans,
    cover: 'gradient', decor: 'circles', content: 'side-stripe', art: 'blobs', contentArt: 'corner',
  ...
  aurora: {
    key: 'aurora', ...sans,
    cover: 'gradient', decor: 'none', content: 'side-stripe', art: 'glow', contentArt: 'corner',
    bg: '0B1020', surface: '161C33',
    title: 'F1F5F9', text: 'D0D6E6', muted: '8B93A8',
    accent: '34D399', accent2: 'A78BFA', accentText: '0B1020',
    coverBg: '0B1020', coverBg2: '1E1B4B', coverFg: 'FFFFFF'
  },
  sunset: {
    key: 'sunset', ...sans,
    cover: 'gradient', decor: 'none', content: 'title-band', art: 'waves', contentArt: 'waves',
    bg: 'FFFDFA', surface: 'FFF0EA',
    title: '7C2D12', text: '3B2A26', muted: 'A08A83',
    accent: 'F97316', accent2: 'EC4899', accentText: 'FFFFFF',
    coverBg: 'F59E0B', coverBg2: '9333EA', coverFg: 'FFFFFF'
  },
  ocean: {
    key: 'ocean', ...sans,
    cover: 'gradient', decor: 'none', content: 'title-band', art: 'waves', contentArt: 'waves',
    bg: 'F0F9FF', surface: 'E0F2FE',
    title: '0C4A6E', text: '1E3A4A', muted: '6B8FA3',
    accent: '0891B2', accent2: '38BDF8', accentText: 'FFFFFF',
    coverBg: '0369A1', coverBg2: '06B6D4', coverFg: 'FFFFFF'
  },
  geometric: {
    key: 'geometric', ...sans,
    cover: 'gradient', decor: 'none', content: 'minimal', art: 'mesh', contentArt: 'corner',
    bg: 'FFFFFF', surface: 'F1F5F9',
    title: '0F172A', text: '1E293B', muted: '64748B',
    accent: '0EA5E9', accent2: 'F43F5E', accentText: 'FFFFFF',
    coverBg: '0F172A', coverBg2: '1E3A8A', coverFg: 'FFFFFF'
  },
  blueprint: {
    key: 'blueprint', ...sans,
    cover: 'solid', decor: 'lines', content: 'side-stripe', art: 'grid', contentArt: 'grid',
    bg: '0B2545', surface: '13315C',
    title: 'FFFFFF', text: 'DCE7F5', muted: '8DA9C4',
    accent: '5BC0EB', accent2: 'FDE74C', accentText: '0B2545',
    coverBg: '0B2545', coverBg2: '13315C', coverFg: 'FFFFFF'
  },
  chalkboard: {
    key: 'chalkboard', ...kai,
    cover: 'solid', decor: 'none', content: 'accent-bar', art: 'chalk', contentArt: 'chalk',
    bg: '1F3B32', surface: '2A4A3D',
    title: 'FFFFFF', text: 'EDEDE4', muted: 'B7C4BB',
    accent: 'FFD166', accent2: 'F4A261', accentText: '1F3B32',
    coverBg: '1F3B32', coverBg2: '244639', coverFg: 'FFFFFF'
  },
  luxury: {
    key: 'luxury', ...serif,
    cover: 'solid', decor: 'lines', content: 'minimal', art: 'frame', contentArt: 'frame',
    bg: '111111', surface: '1C1C1C',
    title: 'F5E9C8', text: 'E5E1D8', muted: '9A948A',
    accent: 'C9A227', accent2: '8C6D1F', accentText: '111111',
    coverBg: '0A0A0A', coverBg2: '1A1A1A', coverFg: 'F5E9C8'
  },
  candy: {
    key: 'candy', ...sans,
    cover: 'gradient', decor: 'circles', content: 'card', art: 'blobs', contentArt: 'corner',
    bg: 'FFFFFF', surface: 'FDF2F8',
    title: '6D28D9', text: '3F3F46', muted: 'A1A1AA',
    accent: 'EC4899', accent2: '22D3EE', accentText: 'FFFFFF',
    coverBg: 'F9A8D4', coverBg2: '93C5FD', coverFg: '4C1D95'
  },
  minimal: {
    key: 'minimal', ...sans,
    cover: 'solid', decor: 'lines', content: 'minimal', art: 'none', contentArt: 'none',
  ...
  academic: {
    key: 'academic', ...serif,
    cover: 'solid', decor: 'lines', content: 'minimal', art: 'none', contentArt: 'frame',
  ...
  education: {
    key: 'education', ...sans,
    cover: 'gradient', decor: 'circles', content: 'card', art: 'dots', contentArt: 'corner',
  ...
  split: {
    key: 'split', ...sans,
    cover: 'split', decor: 'none', content: 'title-band', art: 'none', contentArt: 'none',
  ...
  dark: {
    key: 'dark', ...sans,
    cover: 'solid', decor: 'none', content: 'accent-bar', art: 'rings', contentArt: 'none',
  ...
  nature: {
    key: 'nature', ...sans,
    cover: 'solid', decor: 'none', content: 'accent-bar', art: 'blobs', contentArt: 'corner',
...
export const slideThemeToCssVars = (theme) => ({
  ...
  '--slide-font': theme.bodyFont === SLIDE_KAI_FONT_FACE ? SLIDE_KAI_FONT_STACK : SLIDE_FONT_STACK,
  '--slide-title-font': theme.titleStack || SLIDE_FONT_STACK
})

/** 主题 → 幻灯片根节点的版式类名（预览用） */
export const slideThemeClassNames = (theme) =>
  `cover-${theme.cover} decor-${theme.decor} layout-${theme.content}${theme.serif ? ' serif-title' : ''}${isDarkHex(theme.bg) ? ' dark-bg' : ''}`
