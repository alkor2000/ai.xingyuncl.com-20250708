...
--
-- Host: localhost    Database: ai_platform
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Agent执行记录表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `agent_node_executions`
--

DROP TABLE IF EXISTS `agent_node_executions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=219 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='节点执行日志表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `agent_node_types`
--

DROP TABLE IF EXISTS `agent_node_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `agent_workflow_templates`
--

DROP TABLE IF EXISTS `agent_workflow_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI工作流主表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ai_model_groups`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=508 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI模型与用户组关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI模型配置表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `api_service_actions`
--
...
--
-- Table structure for table `application_form_config`
--

DROP TABLE IF EXISTS `application_form_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `calendar_ai_analyses`
--

DROP TABLE IF EXISTS `calendar_ai_analyses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI分析历史表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `calendar_background_knowledge`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='日历事项表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `calendar_prompt_templates`
--

DROP TABLE IF EXISTS `calendar_prompt_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `calendar_prompt_templates_backup_20251011`
--

DROP TABLE IF EXISTS `calendar_prompt_templates_backup_20251011`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='日历用户设置表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `casbin_deny_policies`
--

DROP TABLE IF EXISTS `casbin_deny_policies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `casbin_metadata`
--

DROP TABLE IF EXISTS `casbin_metadata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8798 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户积分变动历史记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `gemini_files`
--

DROP TABLE IF EXISTS `gemini_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `html_pages_slug_backup`
--
...
--
-- Table structure for table `html_projects`
--
...
--
-- Table structure for table `html_resources`
--
...
--
-- Table structure for table `invitation_code_logs`
--

DROP TABLE IF EXISTS `invitation_code_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `knowledge_module_tag_permissions`
--

DROP TABLE IF EXISTS `knowledge_module_tag_permissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `knowledge_modules`
--
...
--
-- Table structure for table `midjourney_tasks`
--
...
--
-- Table structure for table `module_combination_items`
--
...
--
-- Table structure for table `module_combinations`
--
...
--
-- Table structure for table `oss_config`
--
...
--
-- Table structure for table `smart_app_categories`
--

DROP TABLE IF EXISTS `smart_app_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `smart_apps`
--

DROP TABLE IF EXISTS `smart_apps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `storage_credit_config`
--

DROP TABLE IF EXISTS `storage_credit_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `storage_credits_config_simple`
--
...
--
-- Table structure for table `system_prompt_groups`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=1542 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统配置表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `teaching_global_authorizations`
--

DROP TABLE IF EXISTS `teaching_global_authorizations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_global_authorizations_backup_20251109_122011`
--

DROP TABLE IF EXISTS `teaching_global_authorizations_backup_20251109_122011`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_lesson_drafts`
--

DROP TABLE IF EXISTS `teaching_lesson_drafts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_lesson_plans`
--

DROP TABLE IF EXISTS `teaching_lesson_plans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_lessons`
--

DROP TABLE IF EXISTS `teaching_lessons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_module_group_relations`
--

DROP TABLE IF EXISTS `teaching_module_group_relations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_module_groups`
--

DROP TABLE IF EXISTS `teaching_module_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_modules`
--

DROP TABLE IF EXISTS `teaching_modules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_permissions`
--

DROP TABLE IF EXISTS `teaching_permissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `teaching_permissions_backup_20251031`
--
...
--
-- Table structure for table `teaching_view_logs`
--

DROP TABLE IF EXISTS `teaching_view_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4654 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户文件夹表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户分组表（支持独立站点配置）';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `user_mindmaps`
--

DROP TABLE IF EXISTS `user_mindmaps`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `user_model_restrictions`
--
...
--
-- Table structure for table `user_smart_app_favorites`
--

DROP TABLE IF EXISTS `user_smart_app_favorites`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `user_tag_history`
--
...
--
-- Table structure for table `user_tag_relations`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=706 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户表 - 包含账号有效期和积分有效期';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary view structure for view `v_teaching_permission_hierarchy`
--

DROP TABLE IF EXISTS `v_teaching_permission_hierarchy`;
...
--
-- Temporary view structure for view `v_user_accessible_teaching_modules`
--

DROP TABLE IF EXISTS `v_user_accessible_teaching_modules`;
...
--
-- Temporary view structure for view `v_user_tags_detail`
--

DROP TABLE IF EXISTS `v_user_tags_detail`;
...
--
-- Table structure for table `video_models`
--
...
--
-- Table structure for table `wiki_editors`
--

DROP TABLE IF EXISTS `wiki_editors`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping events for database 'ai_platform'
--
/*!50106 SET @save_time_zone= @@TIME_ZONE */ ;
/*!50106 DROP EVENT IF EXISTS `daily_cleanup_expired_tokens` */;
DELIMITER ;;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`ai_user`@`localhost`*/ /*!50106 EVENT `daily_cleanup_expired_tokens` ON SCHEDULE EVERY 1 DAY STARTS '2025-07-14 04:26:20' ON COMPLETION NOT PRESERVE ENABLE DO CALL cleanup_expired_tokens() */ ;;
...
--
-- Dumping routines for database 'ai_platform'
--
/*!50003 DROP PROCEDURE IF EXISTS `add_sequence_number_column` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`ai_user`@`localhost` PROCEDURE `add_sequence_number_column`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `migrate_teaching_auth_to_dual_layer` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`ai_user`@`localhost` PROCEDURE `migrate_teaching_auth_to_dual_layer`()
BEGIN
...
--
-- Final view structure for view `v_teaching_permission_hierarchy`
--
...
--
-- Final view structure for view `v_user_accessible_teaching_modules`
--
...
--
-- Final view structure for view `v_user_tags_detail`
--
...
-- Dump completed on 2026-01-24  0:23:57
